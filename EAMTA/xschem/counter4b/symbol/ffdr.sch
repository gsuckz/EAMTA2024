...
C {devices/lab_pin.sym} 720 -920 0 0 {name=p24 sig_type=std_logic lab=nclk}
...
C {devices/lab_pin.sym} 770 -920 0 1 {name=p27 sig_type=std_logic lab=clk}
...
C {devices/iopin.sym} 330 -870 2 0 {name=p32 lab=D}
